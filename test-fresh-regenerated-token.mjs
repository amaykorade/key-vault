...
const freshToken = 'tok_user-1755114408989-8k4l6dqkn_0c71b957167e85653ad1b30db10cd41d'; // Freshly regenerated token

async function testFreshRegeneratedToken() {
  console.log('🔑 Testing freshly regenerated token from frontend...\n');

  try {
    // Test 1: Verify authentication with your fresh regenerated token
    console.log('1️⃣ Testing authentication with fresh regenerated token...');
