...
async function testAPI() {
  ...
  try {
    ...
    console.log('\n2️⃣ Fetching DB_URL key from Webmeter/Database/DB_URL (DEVELOPMENT)...');
    ...
    console.log('\n5️⃣ Testing with production environment (should not find DB_URL)...');
    ...
    if (prodResponse.ok) {
      ...
      console.log('⚠️ Found key in production (unexpected):', prodData.key?.name);
    } else {
