...
const apiToken = 'tok_user-1755114408989-8k4l6dqkn_tddscy1am4'; // User's actual token

async function testUserToken() {
  console.log('🔑 Testing your actual API token...\n');

  try {
    // Test 1: Verify authentication with your token
    console.log('1️⃣ Testing authentication with your token...');
