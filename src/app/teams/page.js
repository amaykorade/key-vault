...
export default function TeamsPage() {
  ...
  const getRoleBadge = (team, userId) => {
    if (team.ownerId === userId) {
      return <span className="bg-purple-600 text-white px-2 py-1 rounded-full text-xs font-medium">Owner</span>;
    }
      ...
      <div className="max-w-6xl mx-auto py-8 px-6">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-400">Manage your teams and share keys with members</p>
          </div>
          {canCreateTeam ? (
            <Button 
        ...
        {teams.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {teams.map(team => (
              <Card key={team.id} className="hover:bg-gray-750 transition-colors">
